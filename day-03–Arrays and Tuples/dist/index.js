 ...
 */
let studentNames = ["Alman", "Sara", "John"];
/**
 ...
 * [name, age, isActive]
 */
let userProfile = ["Altaseb", 20, true];
/**
 * Accessing tuple elements by index.
 * Each index has a known type.
 */
let profileName = userProfile[0];
let profileAge = userProfile[1];
let profileStatus = userProfile[2];
