 ...
 */
const messageDiv = selectElement<HTMLDivElement>("message");
...
const passwordInput = selectElement<HTMLInputElement>("password");
const loginButton = selectElement<HTMLButtonElement>("loginBtn");
